@extends('deskapp.app')
@section('tittle', 'Nomor LDP CA Backdate')
@section('judul', 'Nomor LDP CA Backdate')
@section('halaman', 'Nomor LDP CA Backdate')
@section('submenu', 'Ambil Nomor LDP CA Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor LDP CA Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/caldp/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd-CA/LDP/B</div> 
            @error('rubrik')
