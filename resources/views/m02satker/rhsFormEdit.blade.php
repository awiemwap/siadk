@extends('deskapp.app')
@section('tittle', ' Edit M02 Satker Rahasia By Admin')
@section('judul', 'M02 Satker Rahasia')
@section('halaman', 'M02 Satker Rahasia')
@section('submenu', 'Edit M02 Satker Rahasia By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor M02 Satker Rahasia By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02satkerrhs/store">
            {{ method_field('patch') }}
            @csrf
