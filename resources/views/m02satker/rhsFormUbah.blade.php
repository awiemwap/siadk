@extends('deskapp.app')
@section('tittle', ' Edit M02 Satker Rahasia')
@section('judul', 'M02 Satker Rahasia')
@section('halaman', 'M02 Satker Rahasia')
@section('submenu', 'Ubah M02 Satker Rahasia')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor M02 Satker Rahasia</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02satkerrhs/update">
            {{ method_field('patch') }}
            @csrf  
