@extends('deskapp.app')
@section('tittle', ' Edit LDP CA By Admin')
@section('judul', 'Nomor LDP CA KEKDA')
@section('halaman', 'Nomor LDP CA')
@section('submenu', 'Edit Nomor LDP CA By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor LDP CA By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/caldp/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <a href="{{ route('caldp') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
