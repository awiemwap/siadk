@extends('deskapp.app')
@section('tittle', ' Edit M02 CA By Admin')
@section('judul', 'M02 CA')
@section('halaman', 'M02 CA')
@section('submenu', 'Edit M02 CA By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor M02 CA By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02CA/store">
            {{ method_field('patch') }}
            @csrf
