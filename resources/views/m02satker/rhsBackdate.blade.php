@extends('deskapp.app')
@section('tittle', 'M02 Satker Rahasia Backdate')
@section('judul', 'M02 Satker Rahasia Backdate')
@section('halaman', 'M02 Satker Rahasia Backdate')
@section('submenu', 'Ambil M02 Satker Rahasia Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor M02 Satker Rahasia Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02satkerrhs/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/M02/Rhs</div> 
            @error('rubrik')
            ...
            <a href="{{ route('m02satkerrhs') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
