@extends('deskapp.app')
@section('tittle', ' Edit M02 Satker Biasa By Admin')
@section('judul', 'M02 Satker Biasa')
@section('halaman', 'M02 Satker Biasa')
@section('submenu', 'Edit M02 Satker Biasa By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor M02 Satker Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02satkerbiasa/store">
            {{ method_field('patch') }}
            @csrf
