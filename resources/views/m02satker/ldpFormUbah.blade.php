@extends('deskapp.app')
@section('tittle', ' Edit LDP CA')
@section('judul', 'LDP CA')
@section('halaman', 'LDP CA')
@section('submenu', 'Ubah LDP CA')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor LDP CA</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/caldp/update">
            {{ method_field('patch') }}
            @csrf  
