@extends('deskapp.app')
@section('tittle', 'Siaran Pers Backdate')
@section('judul', 'Siaran Pers Backdate')
@section('halaman', 'Siaran Pers Backdate')
@section('submenu', 'Ambil Siaran Pers Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Siaran Pers Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/siaran/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/SiaranPers/B</div> 
            @error('rubrik')
            ...
            <a href="{{ route('siaran') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
