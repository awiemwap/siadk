@extends('deskapp.app')
@section('tittle', ' Edit Siaran Pers By Admin')
@section('judul', 'Siaran Pers')
@section('halaman', 'Siaran Pers')
@section('submenu', 'Edit Siaran Pers By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Risalah Rapat Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/siaran/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tanggal Siaran Pers</b></label>
