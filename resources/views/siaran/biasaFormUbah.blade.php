@extends('deskapp.app')
@section('tittle', ' Edit Siaran Pers')
@section('judul', 'Siaran Pers')
@section('halaman', 'Siaran Pers')
@section('submenu', 'Siaran Pers')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor Siaran Pers</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/siaran/update">
            {{ method_field('patch') }}
            @csrf  
