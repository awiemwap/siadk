@extends('deskapp.app')
@section('tittle', ' Edit Keputusan PBI By Admin')
@section('judul', 'Keputusan PBI')
@section('halaman', 'Keputusan PBI')
@section('submenu', 'Edit Keputusan PBI By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Keputusan PBI By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/pbi/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tanggal Keputusan PBI</b></label>
