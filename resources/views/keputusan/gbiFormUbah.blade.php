@extends('deskapp.app')
@section('tittle', ' Keputusan GBI')
@section('judul', 'Keputusan GBI')
@section('halaman', 'Keputusan GBI')
@section('submenu', 'Ubah Keputusan GBI')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor Keputusan GBI</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/gbi/update">
            {{ method_field('patch') }}
            @csrf  
