@extends('deskapp.app')
@section('tittle', ' Keputusan PBI')
@section('judul', 'Keputusan PBI')
@section('halaman', 'Keputusan PBI')
@section('submenu', 'Ubah Keputusan PBI')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor Keputusan PBI</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/pbi/update">
            {{ method_field('patch') }}
            @csrf  
