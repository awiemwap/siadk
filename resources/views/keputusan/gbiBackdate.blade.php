@extends('deskapp.app')
@section('tittle', 'Keputusan GBI Backdate')
@section('judul', 'Keputusan GBI Backdate')
@section('halaman', 'Keputusan GBI Backdate')
@section('submenu', 'Ambil Keputusan GBI Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Keputusan GBI Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/gbi/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/KEP/GBI/Kd/2023</div> 
            @error('rubrik')
