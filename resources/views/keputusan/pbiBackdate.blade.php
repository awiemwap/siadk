@extends('deskapp.app')
@section('tittle', 'Keputusan PBI Backdate')
@section('judul', 'Keputusan PBI Backdate')
@section('halaman', 'Keputusan PBI Backdate')
@section('submenu', 'Ambil Keputusan PBI Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Keputusan PBI Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/pbi/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kep.KPw/KD/INTERN 2023</div> 
            @error('rubrik')
            ...
            <a href="{{ route('pbi') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
