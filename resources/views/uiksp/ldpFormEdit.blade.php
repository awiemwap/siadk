@extends('deskapp.app')
@section('tittle', ' Edit LDP UIKSPPSPPUR By Admin')
@section('judul', 'Nomor LDP UIKSPPSPPUR KEKDA')
@section('halaman', 'Nomor LDP UIKSPPSPPUR')
@section('submenu', 'Edit Nomor LDP UIKSPPSPPUR By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor LDP UIKSPPSPPUR By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/uikspldp/store">
            {{ method_field('patch') }}
            @csrf
