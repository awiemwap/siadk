@extends('deskapp.app')
@section('tittle', ' Edit TV 01 UIKSPPSPPUR By Admin')
@section('judul', 'TV 01 UIKSPPSPPUR')
@section('halaman', 'TV 01 UIKSPPSPPUR')
@section('submenu', 'Edit TV 01 UIKSPPSPPUR By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor TV 01 UIKSPPSPPUR  By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/uiksptv01/store">
            {{ method_field('patch') }}
            @csrf
