@extends('deskapp.app')
@section('tittle', ' Edit M02 UIKSPPSPPUR Rahasia')
@section('judul', 'M02 UIKSPPSPPUR Rahasia')
@section('halaman', 'M02 UIKSPPSPPUR Rahasia')
@section('submenu', 'Ubah M02 UIKSPPSPPUR Rahasia')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor M02 UIKSPPSPPUR Rahasia</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02uiksprhs/update">
            {{ method_field('patch') }}
            @csrf  
