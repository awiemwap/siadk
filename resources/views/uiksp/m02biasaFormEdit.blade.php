@extends('deskapp.app')
@section('tittle', ' Edit M02 UIKSPPSPPUR By Admin')
@section('judul', 'M02 UIKSPPSPPUR Biasa')
@section('halaman', 'M02 UIKSPPSPPUR Biasa')
@section('submenu', 'Edit M02 UIKSPPSPPUR Biasa By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor M02 UIKSPPSPPUR Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02uikspbiasa/store">
            {{ method_field('patch') }}
            @csrf
