@extends('deskapp.app')
@section('tittle', ' Edit BANA By Admin')
@section('judul', 'BANA')
@section('halaman', 'BANA')
@section('submenu', 'Edit BANA By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor BANA By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/bana/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tanggal BANA</b></label>
