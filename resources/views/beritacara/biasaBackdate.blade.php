@extends('deskapp.app')
@section('tittle', 'Berita Acara Biasa Backdate')
@section('judul', 'Berita Acara Biasa Backdate')
@section('halaman', 'Berita Acara Biasa Backdate')
@section('submenu', 'Ambil Berita Acara Biasa Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Berita Acara Biasa Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/babiasa/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/BA/B</div> 
            @error('rubrik')
            ...
            <a href="{{ route('babiasa') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
