@extends('deskapp.app')
@section('tittle', ' Berita Acara Rahasia')
@section('judul', 'Berita Acara Rahasia')
@section('halaman', 'Berita Acara Rahasia')
@section('submenu', 'Ubah Berita Acara Rahasia')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor Berita Acara Rahasia</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/barahasia/update">
            {{ method_field('patch') }}
            @csrf  
