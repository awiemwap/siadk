@extends('deskapp.app')
@section('tittle', 'BANA Backdate')
@section('judul', 'BANA Backdate')
@section('halaman', 'BANA Backdate')
@section('submenu', 'Ambil BANA Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor BANA Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/bana/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/BANA/B</div> 
            @error('rubrik')
            ...
            <a href="{{ route('bana') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
