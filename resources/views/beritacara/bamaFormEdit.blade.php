@extends('deskapp.app')
@section('tittle', ' Edit BAMA By Admin')
@section('judul', 'BAMA')
@section('halaman', 'BAMA')
@section('submenu', 'Edit BAMA By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor BAMA By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/bama/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tanggal BAMA</b></label>
