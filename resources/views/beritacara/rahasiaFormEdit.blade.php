@extends('deskapp.app')
@section('tittle', ' Edit Berita Acara Rahasia By Admin')
@section('judul', 'Berita Acara Rahasia')
@section('halaman', 'Berita Acara Rahasia')
@section('submenu', 'Edit Berita Acara Rahasia By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Berita Acara Rahasia By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/barahasia/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tanggal Berita Acara</b></label>
