@extends('deskapp.app')
@section('tittle', 'Berita Acara Rahasia Backdate')
@section('judul', 'Berita Acara Rahasia Backdate')
@section('halaman', 'Berita Acara Rahasia Backdate')
@section('submenu', 'Ambil Berita Acara Rahasia Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
      ...
      <br>
        <form method="POST" id="quickForm" action="/barahasia/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/BA/Rhs</div> 
            @error('rubrik')
            ...
            <a href="{{ route('barahasia') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
