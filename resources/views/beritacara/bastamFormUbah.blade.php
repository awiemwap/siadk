@extends('deskapp.app')
@section('tittle', ' Edit BASTAM')
@section('judul', 'BASTAM')
@section('halaman', 'BASTAM')
@section('submenu', 'Ubah BASTAM')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor BASTAM</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/bastam/update">
            {{ method_field('patch') }}
            @csrf  
