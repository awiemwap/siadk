@extends('deskapp.app')
@section('tittle', ' Edit BASTAM By Admin')
@section('judul', 'BASTAM')
@section('halaman', 'BASTAM')
@section('submenu', 'Edit BASTAM By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor BASTAM By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/bastam/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tahun</b></label>
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tanggal BASTAM</b></label>
