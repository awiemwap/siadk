@extends('deskapp.app')
@section('tittle', ' Edit Berita Acara Biasa By Admin')
@section('judul', 'Berita Acara Biasa')
@section('halaman', 'Berita Acara Biasa')
@section('submenu', 'Edit Berita Acara Biasa By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Berita Acara Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/babiasa/store">
            {{ method_field('patch') }}
            @csrf
