@extends('deskapp.app')
@section('tittle', 'BASTAM Backdate')
@section('judul', 'BASTAM Backdate')
@section('halaman', 'BASTAM Backdate')
@section('submenu', 'Ambil BASTAM Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor BASTAM Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/bastam/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/BASTAM/B</div> 
            @error('rubrik')
            ...
            <a href="{{ route('bastam') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
