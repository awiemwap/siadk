@extends('deskapp.app')
@section('tittle', ' Edit Surat Biasa By Admin')
@section('judul', 'Surat Biasa')
@section('halaman', 'Surat Biasa')
@section('submenu', 'Edit Surat Biasa By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Surat Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/suratbiasa/store">
            {{ method_field('patch') }}
            @csrf
