@extends('deskapp.app')
@section('tittle', ' Edit Surat Tugas By Admin')
@section('judul', 'Surat Tugas')
@section('halaman', 'Surat Tugas')
@section('submenu', 'Edit Surat Tugas By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Surat Tugas By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/surattugas/store">
            {{ method_field('patch') }}
            @csrf
