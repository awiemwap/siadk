@extends('deskapp.app')
@section('tittle', 'Surat Tugas Backdate')
@section('judul', 'Surat Tugas Backdate')
@section('halaman', 'Surat Tugas Backdate')
@section('submenu', 'Ambil Surat Tugas Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Surat Tugas Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/surattugas/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.25/1A/Kd/ST</div> 
            @error('rubrik')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            <div class="form-group">
                <label for="tujuan"><b>Pelaksana PDDN</b></label>
            ...
            <a href="{{ route('surattugas') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
