@extends('deskapp.app')
@section('tittle', ' Edit Surat Rahasia By Admin')
@section('judul', 'Surat Rahasia')
@section('halaman', 'Surat Rahasia')
@section('submenu', 'Edit Surat Rahasia By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Surat Rahasia By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/suratrahasia/store">
            {{ method_field('patch') }}
            @csrf
