@extends('deskapp.app')
@section('tittle', 'Surat Biasa Backdate')
@section('judul', 'Surat Biasa Backdate')
@section('halaman', 'Surat Biasa Backdate')
@section('submenu', 'Ambil Surat Biasa Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Surat Biasa Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/suratbiasa/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/Srt/B</div> 
            @error('rubrik')
