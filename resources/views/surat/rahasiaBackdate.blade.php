@extends('deskapp.app')
@section('tittle', 'Surat Rahasia Backdate')
@section('judul', 'Surat Rahasia Backdate')
@section('halaman', 'Surat Rahasia Backdate')
@section('submenu', 'Ambil Surat Rahasia Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Surat Rahasia Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/suratrahasia/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/Srt/Rhs</div> 
            @error('rubrik')
            ...
            <a href="{{ route('suratrahasia') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
