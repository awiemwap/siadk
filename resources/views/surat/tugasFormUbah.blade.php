@extends('deskapp.app')
@section('tittle', ' Edit Surat Tugas')
@section('judul', 'Surat Tugas')
@section('halaman', 'Surat Tugas')
@section('submenu', 'Ubah Surat Tugas')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor Surat Tugas</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/surattugas/update">
            {{ method_field('patch') }}
            @csrf  
