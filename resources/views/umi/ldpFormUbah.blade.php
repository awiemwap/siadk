@extends('deskapp.app')
@section('tittle', ' Edit LDP 02 UMI')
@section('judul', 'LDP 02 UMI')
@section('halaman', 'LDP 02 UMI')
@section('submenu', 'Ubah LDP 02 UMI')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor LDP 02 UMI</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/umildp/update">
            {{ method_field('patch') }}
            @csrf  
