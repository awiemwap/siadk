@extends('deskapp.app')
@section('tittle', ' Edit M02 UMI By Rahasia')
@section('judul', 'M02 UMI Rahasia')
@section('halaman', 'M02 UMI Rahasia')
@section('submenu', 'Edit M02 UMI Rahasia By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor M02 UMI Rahasia Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02umirhs/store">
            {{ method_field('patch') }}
            @csrf
