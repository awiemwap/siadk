@extends('deskapp.app')
@section('tittle', ' Edit M02 UMI Biasa')
@section('judul', 'M02 UMI Biasa')
@section('halaman', 'M02 UMI Biasa')
@section('submenu', 'Ubah M02 UMI Biasa')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor M02 UMI Biasa</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02umibiasa/update">
            {{ method_field('patch') }}
            @csrf  
