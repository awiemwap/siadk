@extends('deskapp.app')
@section('tittle', ' Edit M02 UMI By Admin')
@section('judul', 'M02 UMI Biasa')
@section('halaman', 'M02 UMI Biasa')
@section('submenu', 'Edit M02 UMI By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor M02 UMI Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02umibiasa/store">
            {{ method_field('patch') }}
            @csrf
