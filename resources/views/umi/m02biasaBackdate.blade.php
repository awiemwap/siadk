@extends('deskapp.app')
@section('tittle', 'M02 UMI Biasa Backdate')
@section('judul', 'M02 UMI Biasa Backdate')
@section('halaman', 'M02 UMI Biasa Backdate')
@section('submenu', 'Ambil M02 UMI Biasa Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor M02 UMI Biasa Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02umibiasa/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd-UMI/M02/Biasa</div> 
            @error('rubrik')
            ...
            <a href="{{ route('m02umibiasa') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
