@extends('deskapp.app')
@section('tittle', ' Edit TV 01 Tim KEKDA By Admin')
@section('judul', 'TV 01 Tim KEKDA')
@section('halaman', 'TV 01 TIm KEKDA')
@section('submenu', 'Edit TV 01 Tim KEKDA By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor TV 01 TIm KEKDA  By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/kekdatv01/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <a href="{{ route('kekdatv01') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
