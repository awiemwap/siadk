...
@section('submenu', 'Edit M02 Tim KEKDA By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor M02 Tim KEKDA Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02kekdabiasa/store">
            {{ method_field('patch') }}
            @csrf
