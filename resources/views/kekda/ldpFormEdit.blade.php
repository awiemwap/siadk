@extends('deskapp.app')
@section('tittle', ' Edit LDP Tim KEKDA By Admin')
@section('judul', 'Nomor LDP Tim KEKDA KEKDA')
@section('halaman', 'Nomor LDP Tim KEKDA')
@section('submenu', 'Edit Nomor LDP Tim KEKDA By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor LDP Tim KEKDA By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/kekdaldp/store">
            {{ method_field('patch') }}
            @csrf
