@extends('deskapp.app')
@section('tittle', 'M02 Tim KEKDA Rahasia Backdate')
@section('judul', 'M02 Tim KEKDA Rahasia Backdate')
@section('halaman', 'M02 Tim KEKDA Rahasia Backdate')
@section('submenu', 'Ambil M02 Tim KEKDA Rahasia Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor M02 Tim KEKDA Rahasia Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02kekdarhs/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd-TIK/M02/Rhs</div> 
            @error('rubrik')
