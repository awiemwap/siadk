@extends('deskapp.app')
@section('tittle', ' Edit TV 01 Tim KEKDA')
@section('judul', 'TV 01 KEKDA')
@section('halaman', 'TV 01 KEKDA')
@section('submenu', 'Ubah TV 01 KEKDA')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor TV 01 KEKDA</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/kekdatv01/update">
            {{ method_field('patch') }}
            @csrf  
