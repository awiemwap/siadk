@extends('deskapp.app')
@section('tittle', ' Edit LDP Tim KEKDA')
@section('judul', 'LDP Tim KEKDA')
@section('halaman', 'LDP Tim KEKDA')
@section('submenu', 'Ubah LDP Tim KEKDA')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor LDP Tim KEKDA</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/kekdaldp/update">
            {{ method_field('patch') }}
            @csrf  
