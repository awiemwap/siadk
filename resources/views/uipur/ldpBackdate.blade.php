@extends('deskapp.app')
@section('tittle', 'Nomor LDP UIPUR Backdate')
@section('judul', 'Nomor LDP UIPUR Backdate')
@section('halaman', 'Nomor LDP UIPUR Backdate')
@section('submenu', 'Ambil Nomor LDP UIPUR Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor LDP UIPUR Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/uipurldp/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd-UIPUR/LDP/B</div> 
            @error('rubrik')
