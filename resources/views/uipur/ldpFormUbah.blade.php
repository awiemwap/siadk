@extends('deskapp.app')
@section('tittle', ' Edit LDP UIPUR')
@section('judul', 'LDP UIPUR')
@section('halaman', 'LDP UIPUR')
@section('submenu', 'Ubah LDP UIPUR')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor LDP UIPUR</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/uipurldp/update">
            {{ method_field('patch') }}
            @csrf  
