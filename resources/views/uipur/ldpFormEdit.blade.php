@extends('deskapp.app')
@section('tittle', ' Edit LDP UIPUR By Admin')
@section('judul', 'Nomor LDP UIPUR KEKDA')
@section('halaman', 'Nomor LDP UIPUR')
@section('submenu', 'Edit Nomor LDP UIPUR By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor LDP UIPUR By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/uipurldp/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tanggal LDP</b></label>
            ...
            <div class="form-group">
                  <label for="nominal"><b>Nominal (Khusus LDP BI ERP)</b></label>
                  <input type="text" name="nominal" class="form-control" value="{{ $show->nominal }}" id="nominal" placeholder="">
            </div>
               

            <a href="{{ route('uipurldp') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
