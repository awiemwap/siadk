@extends('deskapp.app')
@section('tittle', ' Edit M02 UIPUR Rahasia')
@section('judul', 'M02 UIPUR Rahasia')
@section('halaman', 'M02 UIPUR Rahasia')
@section('submenu', 'Ubah M02 UIPUR Rahasia')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor M02 UIPUR Rahasia</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m02uipurrhs/update">
            {{ method_field('patch') }}
            @csrf  
