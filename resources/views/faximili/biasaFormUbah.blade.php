@extends('deskapp.app')
@section('tittle', ' Edit Faximili Biasa')
@section('judul', 'Faximili Biasa')
@section('halaman', 'Faximili Biasa')
@section('submenu', 'Ubah Faximili Biasa')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor Faximili Biasa</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/faximilibiasa/update">
            {{ method_field('patch') }}
            @csrf  
