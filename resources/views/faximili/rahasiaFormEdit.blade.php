@extends('deskapp.app')
@section('tittle', ' Edit Faximili Rahasia By Admin')
@section('judul', 'Faximili Rahasia')
@section('halaman', 'Faximili Rahasia')
@section('submenu', 'Edit Faximili Rahasia By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Faximili Rahasia By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/faximilirahasia/store">
            {{ method_field('patch') }}
            @csrf
