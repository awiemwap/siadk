@extends('deskapp.app')
@section('tittle', 'Faximili Biasa Backdate')
@section('judul', 'Faximili Biasa Backdate')
@section('halaman', 'Faximili Biasa Backdate')
@section('submenu', 'Ambil Faximili Biasa Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Faximili Biasa Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/faximilibiasa/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/Fax/B</div> 
            @error('rubrik')
            ...
            <a href="{{ route('faximilibiasa') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> | Kembali</a>
