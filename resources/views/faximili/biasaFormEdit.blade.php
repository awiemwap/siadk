@extends('deskapp.app')
@section('tittle', ' Edit Faximili Biasa By Admin')
@section('judul', 'Faximili Biasa')
@section('halaman', 'Faximili Biasa')
@section('submenu', 'Edit Faximili Biasa By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Faximili Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/faximilibiasa/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tanggal Surat</b></label>
