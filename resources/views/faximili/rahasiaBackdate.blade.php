@extends('deskapp.app')
@section('tittle', 'Faximili Rahasia Backdate')
@section('judul', 'Faximili Rahasia Backdate')
@section('halaman', 'Faximili Rahasia Backdate')
@section('submenu', 'Ambil Faximili Rahasia Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Faximili Rahasia Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/faximilirahasia/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/Fax/Rhs</div> 
            @error('rubrik')
