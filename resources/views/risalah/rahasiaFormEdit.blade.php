@extends('deskapp.app')
@section('tittle', ' Edit Risalah Rapata Rahasia By Admin')
@section('judul', 'Risalah Rapat Rahasia')
@section('halaman', 'Risalah Rapat Rahasia')
@section('submenu', 'Edit Risalah Rapat Rahasia By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor Risalah Rapat Rahasia By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/risalahrahasia/store">
            {{ method_field('patch') }}
            @csrf
            ...
            <div class="form-group">
                  <label for="rubrik"><b>Tanggal Risalah Rapat</b></label>
