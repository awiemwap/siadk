@extends('deskapp.app')
@section('tittle', 'Berita Risalah Rapat Backdate')
@section('judul', 'Berita Risalah Rapat Backdate')
@section('halaman', 'Berita Risalah Rapat Backdate')
@section('submenu', 'Ambil Risalah Rapat Biasa Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Risalah Rapata Biasa Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/risalahbiasa/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/Rsl/B</div> 
            @error('rubrik')
