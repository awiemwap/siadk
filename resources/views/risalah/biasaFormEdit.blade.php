@extends('deskapp.app')
@section('tittle', ' Edit Berita Risalah Rapat By Admin')
@section('judul', 'Berita Risalah Rapat')
@section('halaman', 'Berita Risalah Rapat')
@section('submenu', 'Edit Risalah Rapat Biasa By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
      ...
      <br>
        <form method="POST" id="quickForm" action="/risalahbiasa/store">
            {{ method_field('patch') }}
            @csrf
