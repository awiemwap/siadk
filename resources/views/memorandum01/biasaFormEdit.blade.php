@extends('deskapp.app')
@section('tittle', ' Edit M01 Biasa By Admin')
@section('judul', 'Memorandum M01 Biasa')
@section('halaman', 'Memorandum M01 Biasa')
@section('submenu', 'Edit M01 Biasa By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor M.01 Biasa By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m01biasa/store">
            {{ method_field('patch') }}
            @csrf
