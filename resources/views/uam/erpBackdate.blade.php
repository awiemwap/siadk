@extends('deskapp.app')
@section('tittle', 'Form UAM ERP Backdate')
@section('judul', 'Form UAM ERP Backdate')
@section('halaman', 'Form UAM ERP Backdate')
@section('submenu', 'Ambil Form UAM ERP Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor Form UAM ERP Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/erp/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/UAM.RQ/5</div> 
            @error('rubrik')
