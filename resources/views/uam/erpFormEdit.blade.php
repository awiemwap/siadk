@extends('deskapp.app')
@section('tittle', ' Edit UAM ERP By Admin')
@section('judul', 'UAM ERP')
@section('halaman', 'UAM ERP')
@section('submenu', 'Edit UAM ERP By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor UAM ERP By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/erp/store">
            {{ method_field('patch') }}
            @csrf
