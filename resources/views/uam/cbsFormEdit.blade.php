@extends('deskapp.app')
@section('tittle', ' Edit UAM CBS By Admin')
@section('judul', 'UAM CBS')
@section('halaman', 'UAM CBS')
@section('submenu', 'Edit UAM CBS By Admin')
@section('container')
<div class="pd-20 card-box mb-30">
     <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Edit Nomor UAM CBS By Admin</h3>
        </div>
      </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/cbs/store">
            {{ method_field('patch') }}
            @csrf
