@extends('deskapp.app')
@section('tittle', ' Edit UAM ERP')
@section('judul', 'UAM ERP')
@section('halaman', 'UAM ERP')
@section('submenu', 'Ubah UAM ERP')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor UAM ERP</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/erp/update">
            {{ method_field('patch') }}
            @csrf  
