@extends('deskapp.app')
@section('tittle', 'M01 Biasa Backdate')
@section('judul', 'Memorandum M01 Biasa Backdate')
@section('halaman', 'M01 Biasa Backdate')
@section('submenu', 'Ambil M01 Biasa Backdate')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ambil Nomor M.01 Biasa Backdate</h3>
     </div>
    </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/m01biasa/backdateStore">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="alert alert-info" role="alert">Silakan tambahkan Alphabet pada nomor rubrik, contoh No.26/1A/Kd/M.01/B</div> 
            @error('rubrik')
